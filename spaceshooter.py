...
class GravitySprite(Sprite):
    ...
    def step(self, T, dT):
        ...
        R2 = Vector(self.sun2.x-self.x, self.sun2.y-self.y)
        #Ur = R.unit()
        r = R.mag()
        Ux, Uy = R.x/r, R.y/r
        r2 = R2.mag()
        ...
        dt2o2 = dT*dT*0.5
        self.vx = self.vx + (Agx + Agx2 - At*math.sin(self.rotation))* dT
        self.vy = self.vy + (Agy + Agy2 - At*math.cos(self.rotation))* dT
