...
class Spacewar(App):
    ...
    def __init__(self):
        ...
        self.tsprites = {k:Sprite(TextAsset(text=v, width=200, align='center',style='20px Georgia', fill=Color(0xff2222,1))) 
        ...
        self.tsprites['space'].position = (self.width/2 - 80, self.height*3/4)
