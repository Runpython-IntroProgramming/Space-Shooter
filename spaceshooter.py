...
class Stars(Sprite):
    ...
    asset = ImageAsset("images/clouds.png")
    width = 950
    height = 950
...
class Spacewar(App):
    ...
    def __init__(self):
        ...
        self.tsprites = {k:Sprite(TextAsset(text=v, width=250, align='center',style='20px Verdana', fill=Color(0xFF4900,1))) 
        ...
        self.tsprites['space'].position = (self.width/2 - 95, self.height*3/4)
